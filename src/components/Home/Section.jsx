                ...
                <Marquee>
                    <section class="bg-white ">
                        <div class="py-8 mx-auto max-w-screen-xl px-4">
                            ...
                            <div class="grid grid-cols-6 gap-8 text-gray-500 sm:gap-12 md:grid-cols-3 lg:grid-cols-6 ">
                        ...
                        <div class="mx-auto max-w-screen-md sm:text-center">
                            ...
                            <form action="#">
                                <div class="items-center mx-auto mb-3 space-y-1 max-w-screen-sm sm:flex sm:space-y-0">
                                    ...
                                    <div>
                                        <button type="submit" class="py-3 px-5 w-full text-sm font-medium text-center text-white rounded-lg border cursor-pointer bg-blue-700 border-primary-600 sm:rounded-none sm:rounded-r-lg hover:bg-blue-800 focus:ring-4 focus:ring-primary-300">Subscribe</button>
                                    </div>
                                </div>
                                <div class="mx-auto max-w-screen-sm text-sm text-left text-gray-500 newsletter-form-footer">We care about the protection of your data. <a href="" class="font-medium text-blue-600 hover:underline">Read our Privacy Policy</a>.</div>
                            </form>
                        </div>
                    </div>
                </section>
