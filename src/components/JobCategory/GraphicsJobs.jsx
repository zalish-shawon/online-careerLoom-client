...
const GraphicsJobs = ({ job }) => {
    const { _id, image, jobTitle, deadline, maxPrice, minPrice, description } = job;
            ...
            <div class="max-w-2xl mx-auto">
                ...
                <div class="bg-white shadow-md border border-gray-200 rounded-lg lg:max-w-sm h-[460px]">
                    ...
                    <div class="p-5">
                        ...
                        <h5 class="text-gray-900 font-bold text-2xl tracking-tight mb-2">{jobTitle}</h5>

                        <p class="font-normal text-gray-700 mb-1">{description.slice(0, 80)}</p>
                        <div>
